...
export const GreetingSection = () => (
    <section className="first-section h-[500px] lg:h-[650px]">
        <div className="h-full w-full px-4 pt-10 md:pt-[89px] pb-[72px] md:pb-[88px] lg:py-[164px] flex justify-center">
            <div className="flex flex-col gap-5 w-[328px] md:w-[380px] text-center">
                ...
                <span className="text-white text-base leading-[26px] inline-block mb-3">
